...
individualPhenoQTLimagePath = "/home/rfm_node03/Documents/Analyses/RStudioProjects/RIG/Sbi3/BTx623xIS3620C/QTLmapping/ImageBasedPhenotyping/BTx623xIS3620C_v5_1/individualPhenotypeQTLPlots"
combinedQTLimagePath = "/home/rfm_node03/Documents/Analyses/RStudioProjects/RIG/Sbi3/BTx623xIS3620C/QTLmapping/ImageBasedPhenotyping/BTx623xIS3620C_v5_1/scanone_images"
# These two are used for filepaths for a higher stringency run for alpha_value of 0.05 or higher.
# individualPhenoQTLimagePath = "/home/rfm_node03/Documents/Analyses/RStudioProjects/RIG/Sbi3/BTx623xIS3620C/QTLmapping/ImageBasedPhenotyping/BTx623xIS3620C_08-03-2015_v5/individualPhenotypeQTLPlots_highStringency"
# combinedQTLimagePath = "/home/rfm_node03/Documents/Analyses/RStudioProjects/RIG/Sbi3/BTx623xIS3620C/QTLmapping/ImageBasedPhenotyping/BTx623xIS3620C_08-03-2015_v5/scanone_images_highStringency"
...
if (length(phenotype_list) == 0) {
  ...
  for (i in 1:length(phenoNames)) {
    if (grepl("Normalized", phenoNames[i])) {
      phenotype_list <- c(phenotype_list, phenoNames[i])
    }
  }
}
